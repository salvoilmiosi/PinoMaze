...
mazeEditor::mazeEditor() {
    ...
    tools[0] = new toolSelect(1);
    tools[1] = new toolCrop(9);
    tools[2] = new toolWall(3);
    tools[3] = new toolBridge(4);
    tools[4] = new toolStartend(5);
    tools[5] = new toolBlock(6);
    tools[6] = new toolArrow(7);
    tools[7] = new toolTeleport(8);
}
    ...
    case SDL_KEYDOWN:
        ...
        default:
            if (e.key.keysym.scancode >= SDL_SCANCODE_1 &&
                e.key.keysym.scancode < SDL_SCANCODE_1 + TOOL_COUNT && e.key.keysym.scancode <= SDL_SCANCODE_0) {
...
void mazeEditor::render(SDL_Renderer *renderer, int ox, int oy) {
    ...
    if (toolboxTimer > 0) {
        ...
        SDL_Rect select_dstrect = {ox, currentTool * RES_TOOLS_SIZE + oy, RES_TOOLS_SIZE, RES_TOOLS_SIZE};
        ...
        clip_rect.h = RES_TOOLS_SIZE * TOOL_COUNT;
    }
}
